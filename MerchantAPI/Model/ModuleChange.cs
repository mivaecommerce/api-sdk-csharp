...
namespace MerchantAPI
{
	...
	public class ModuleChange : Model
	{
		...
		/// <value>Property ModuleData - VariableValue</value>
		[JsonPropertyName("Module_Data")]
		public VariableValue ModuleData { get; set; }
		...
		/// <returns>VariableValue</returns>
		/// </summary>
		public VariableValue GetModuleData()
		{
			return ModuleData;
		}
		...
		/// <param name="value">VariableValue</param>
		/// <returns>ModuleChange</returns>
		/// </summary>
		public ModuleChange SetModuleData(VariableValue value)
		{
			ModuleData = value;
			return this;
		}
		...
		/// <returns>ModuleChange</returns>
		/// </summary>
		public ModuleChange SetModuleData(dynamic value)
		{
			ModuleData = value is VariableValue ? (VariableValue)value : new VariableValue(value);
			return this;
		}
	}
		...
		public override ModuleChange Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
		{
			...
			while(reader.Read())
			{
				...
				else if (String.Equals(property, "Module_Data", StringComparison.OrdinalIgnoreCase))
				{
					...
					value.ModuleData = JsonSerializer.Deserialize<VariableValue>(ref reader, options);
				}
				else
				{
					reader.Skip();
