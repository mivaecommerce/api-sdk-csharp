...
namespace MerchantAPI
{
	...
	public class Subscription : BaseSubscription
	{
		...
		/// <value>Property ProductPrice - decimal</value>
		...
		/// <value>Property ProductCost - decimal</value>
		...
		/// <value>Property ProductWeight - decimal</value>
		[JsonPropertyName("product_weight")]
		public decimal ProductWeight { get; set; }

		/// <value>Property ProductFormattedWeight - String</value>
		[JsonPropertyName("product_formatted_weight")]
		public String ProductFormattedWeight { get; set; }

		/// <value>Property ProductDescrip - String</value>
		[JsonPropertyName("product_descrip")]
		...
		/// <returns>String</returns>
		/// </summary>
		public String GetProductFormattedWeight()
		{
			return ProductFormattedWeight;
		}
	...
	/// <summary>
	/// Converter for model Subscription
	/// </summary>
	public class SubscriptionConverter : BaseJsonConverter<Subscription>
	{
		public override bool CanConvert(Type typeToConvert)
		{
			return typeToConvert == typeof(Subscription) || typeToConvert.IsSubclassOf(typeof(Subscription));
		}
		...
		public override Subscription Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
		{
			...
			while(reader.Read())
			{
				...
				{
					value.ProductPrice = ReadNextDecimal(ref reader, options);
				}
				...
				{
					value.ProductCost = ReadNextDecimal(ref reader, options);
				}
				...
				{
					value.ProductWeight = ReadNextDecimal(ref reader, options);
				}
				else if (String.Equals(property, "product_formatted_weight", StringComparison.OrdinalIgnoreCase))
				{
					value.ProductFormattedWeight = ReadNextString(ref reader, options);
				}
				else if (String.Equals(property, "product_descrip", StringComparison.OrdinalIgnoreCase))
				{
					value.ProductDescrip = ReadNextString(ref reader, options);
				}
		...
		{
			throw new MerchantAPIException("SubscriptionConverter only supports deserialization");
		}
	}
}
