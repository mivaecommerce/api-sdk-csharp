...
{
	[JsonConverter(typeof(SubscriptionAttributeConverter))]
	public class SubscriptionAttribute : Model
	{
		...
		/// <returns>SubscriptionAttribute</returns>
		/// </summary>
		public SubscriptionAttribute SetCode(String value)
		{
			Code = value;
			return this;
		}
		...
		/// <returns>SubscriptionAttribute</returns>
		/// </summary>
		public SubscriptionAttribute SetTemplateCode(String value)
		{
			TemplateCode = value;
			return this;
		}
		...
		/// <returns>SubscriptionAttribute</returns>
		/// </summary>
		public SubscriptionAttribute SetValue(String value)
		{
			Value = value;
			return this;
		}
	...
	/// <summary>
	/// Converter for model SubscriptionAttribute
	/// </summary>
	public class SubscriptionAttributeConverter : BaseJsonConverter<SubscriptionAttribute>
	{
		public override bool CanConvert(Type typeToConvert)
		{
			return typeToConvert == typeof(SubscriptionAttribute) || typeToConvert.IsSubclassOf(typeof(SubscriptionAttribute));
		}

		public override SubscriptionAttribute Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
		{
			SubscriptionAttribute value = new SubscriptionAttribute();
		...
		public override void Write(Utf8JsonWriter writer, SubscriptionAttribute value, JsonSerializerOptions options)
		{
