...
namespace MerchantAPI
{
	...
	public class AvailabilityGroupCustomerListLoadQueryRequest : CustomerListLoadQueryRequest
	{
		...
		/// </summary>
		public AvailabilityGroupCustomerListLoadQueryRequest(BaseClient client = null, AvailabilityGroup availabilityGroup = null) :
			base(client)
		{
		...
		/// <returns>AvailabilityGroupCustomerListLoadQueryRequest</returns>
		/// </summary>
		public AvailabilityGroupCustomerListLoadQueryRequest SetAvailabilityGroupId(int? value)
		{
		...
		/// <returns>AvailabilityGroupCustomerListLoadQueryRequest</returns>
		/// </summary>
		public AvailabilityGroupCustomerListLoadQueryRequest SetEditAvailabilityGroup(String value)
		{
		...
		/// <returns>AvailabilityGroupCustomerListLoadQueryRequest</returns>
		/// </summary>
		public AvailabilityGroupCustomerListLoadQueryRequest SetAvailabilityGroupName(String value)
		{
		...
		/// <returns>AvailabilityGroupCustomerListLoadQueryRequest</returns>
		/// </summary>
		public AvailabilityGroupCustomerListLoadQueryRequest SetAssigned(bool? value)
		{
			Assigned = value;
			return this;
		}
		...
		/// <returns>AvailabilityGroupCustomerListLoadQueryRequest</returns>
		/// </summary>
		public AvailabilityGroupCustomerListLoadQueryRequest SetUnassigned(bool? value)
		{
			Unassigned = value;
			return this;
		}
		...
		{
			return JsonSerializer.Deserialize<AvailabilityGroupCustomerListLoadQueryResponse>(ref reader, options);
		}

		/// <summary>
		/// Send the request for a response, blocking
		/// <returns>AvailabilityGroupCustomerListLoadQueryResponse</returns>
		/// </summary>
		public new AvailabilityGroupCustomerListLoadQueryResponse Send()
		{
			return Client.SendRequestAsync<AvailabilityGroupCustomerListLoadQueryRequest, AvailabilityGroupCustomerListLoadQueryResponse>(this).Result;
		}

		/// <summary>
		/// Send the request for a response, async
		/// <returns>Task<AvailabilityGroupCustomerListLoadQueryResponse></returns>
		/// </summary>
		public new async Task<AvailabilityGroupCustomerListLoadQueryResponse> SendAsync()
		{
			if (Client == null) throw new MerchantAPIException("Client not assigned to request");

			return await Client.SendRequestAsync<AvailabilityGroupCustomerListLoadQueryRequest, AvailabilityGroupCustomerListLoadQueryResponse>(this);
		}
	}
}
