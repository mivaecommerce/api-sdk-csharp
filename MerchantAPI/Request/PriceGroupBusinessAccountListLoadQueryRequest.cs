...
namespace MerchantAPI
{
	...
	public class PriceGroupBusinessAccountListLoadQueryRequest : BusinessAccountListLoadQueryRequest
	{
		...
		/// </summary>
		public PriceGroupBusinessAccountListLoadQueryRequest(BaseClient client = null, PriceGroup priceGroup = null) :
			base(client)
		{
		...
		/// <returns>PriceGroupBusinessAccountListLoadQueryRequest</returns>
		/// </summary>
		public PriceGroupBusinessAccountListLoadQueryRequest SetPriceGroupId(int? value)
		{
			PriceGroupId = value;
			return this;
		}
		...
		/// <returns>PriceGroupBusinessAccountListLoadQueryRequest</returns>
		/// </summary>
		public PriceGroupBusinessAccountListLoadQueryRequest SetEditPriceGroup(String value)
		{
		...
		/// <returns>PriceGroupBusinessAccountListLoadQueryRequest</returns>
		/// </summary>
		public PriceGroupBusinessAccountListLoadQueryRequest SetPriceGroupName(String value)
		{
		...
		/// <returns>PriceGroupBusinessAccountListLoadQueryRequest</returns>
		/// </summary>
		public PriceGroupBusinessAccountListLoadQueryRequest SetAssigned(bool? value)
		{
			Assigned = value;
			return this;
		}
		...
		/// <returns>PriceGroupBusinessAccountListLoadQueryRequest</returns>
		/// </summary>
		public PriceGroupBusinessAccountListLoadQueryRequest SetUnassigned(bool? value)
		{
			Unassigned = value;
			return this;
		}
		...
		{
			return JsonSerializer.Deserialize<PriceGroupBusinessAccountListLoadQueryResponse>(ref reader, options);
		}

		/// <summary>
		/// Send the request for a response, blocking
		/// <returns>PriceGroupBusinessAccountListLoadQueryResponse</returns>
		/// </summary>
		public new PriceGroupBusinessAccountListLoadQueryResponse Send()
		{
			return Client.SendRequestAsync<PriceGroupBusinessAccountListLoadQueryRequest, PriceGroupBusinessAccountListLoadQueryResponse>(this).Result;
		}

		/// <summary>
		/// Send the request for a response, async
		/// <returns>Task<PriceGroupBusinessAccountListLoadQueryResponse></returns>
		/// </summary>
		public new async Task<PriceGroupBusinessAccountListLoadQueryResponse> SendAsync()
		{
			if (Client == null) throw new MerchantAPIException("Client not assigned to request");

			return await Client.SendRequestAsync<PriceGroupBusinessAccountListLoadQueryRequest, PriceGroupBusinessAccountListLoadQueryResponse>(this);
		}
	}
}
