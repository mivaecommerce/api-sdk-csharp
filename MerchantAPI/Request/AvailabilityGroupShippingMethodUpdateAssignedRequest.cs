...
namespace MerchantAPI
{
	...
	public class AvailabilityGroupShippingMethodUpdateAssignedRequest : Request
	{
		...
		/// </summary>
		public AvailabilityGroupShippingMethodUpdateAssignedRequest(BaseClient client = null, AvailabilityGroup availabilityGroup = null) :
			base(client)
		{
		...
		/// <returns>AvailabilityGroupShippingMethodUpdateAssignedRequest</returns>
		/// </summary>
		public AvailabilityGroupShippingMethodUpdateAssignedRequest SetAvailabilityGroupId(int? value)
		{
		...
		/// <returns>AvailabilityGroupShippingMethodUpdateAssignedRequest</returns>
		/// </summary>
		public AvailabilityGroupShippingMethodUpdateAssignedRequest SetEditAvailabilityGroup(String value)
		{
		...
		/// <returns>AvailabilityGroupShippingMethodUpdateAssignedRequest</returns>
		/// </summary>
		public AvailabilityGroupShippingMethodUpdateAssignedRequest SetAvailabilityGroupName(String value)
		{
		...
		/// <returns>AvailabilityGroupShippingMethodUpdateAssignedRequest</returns>
		/// </summary>
		public AvailabilityGroupShippingMethodUpdateAssignedRequest SetModuleCode(String value)
		{
			ModuleCode = value;
			return this;
		}
		...
		/// <returns>AvailabilityGroupShippingMethodUpdateAssignedRequest</returns>
		/// </summary>
		public AvailabilityGroupShippingMethodUpdateAssignedRequest SetMethodCode(String value)
		{
			MethodCode = value;
			return this;
		}
		...
		/// <returns>AvailabilityGroupShippingMethodUpdateAssignedRequest</returns>
		/// </summary>
		public AvailabilityGroupShippingMethodUpdateAssignedRequest SetAssigned(bool value)
		{
			Assigned = value;
			return this;
		}
		...
		{
			return JsonSerializer.Deserialize<AvailabilityGroupShippingMethodUpdateAssignedResponse>(ref reader, options);
		}

		/// <summary>
		/// Send the request for a response, blocking
		/// <returns>AvailabilityGroupShippingMethodUpdateAssignedResponse</returns>
		/// </summary>
		public new AvailabilityGroupShippingMethodUpdateAssignedResponse Send()
		{
			return Client.SendRequestAsync<AvailabilityGroupShippingMethodUpdateAssignedRequest, AvailabilityGroupShippingMethodUpdateAssignedResponse>(this).Result;
		}

		/// <summary>
		/// Send the request for a response, async
		/// <returns>Task<AvailabilityGroupShippingMethodUpdateAssignedResponse></returns>
		/// </summary>
		public new async Task<AvailabilityGroupShippingMethodUpdateAssignedResponse> SendAsync()
		{
			if (Client == null) throw new MerchantAPIException("Client not assigned to request");

			return await Client.SendRequestAsync<AvailabilityGroupShippingMethodUpdateAssignedRequest, AvailabilityGroupShippingMethodUpdateAssignedResponse>(this);
		}
	}
}
