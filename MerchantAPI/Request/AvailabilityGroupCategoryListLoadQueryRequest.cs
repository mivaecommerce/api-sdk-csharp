...
namespace MerchantAPI
{
	...
	public class AvailabilityGroupCategoryListLoadQueryRequest : CategoryListLoadQueryRequest
	{
		...
		/// </summary>
		public AvailabilityGroupCategoryListLoadQueryRequest(BaseClient client = null, AvailabilityGroup availabilityGroup = null) :
			base(client)
		{
			Function = "AvailabilityGroupCategoryList_Load_Query";
		...
		/// <returns>AvailabilityGroupCategoryListLoadQueryRequest</returns>
		/// </summary>
		public AvailabilityGroupCategoryListLoadQueryRequest SetAvailabilityGroupId(int? value)
		{
		...
		/// <returns>AvailabilityGroupCategoryListLoadQueryRequest</returns>
		/// </summary>
		public AvailabilityGroupCategoryListLoadQueryRequest SetEditAvailabilityGroup(String value)
		{
		...
		/// <returns>AvailabilityGroupCategoryListLoadQueryRequest</returns>
		/// </summary>
		public AvailabilityGroupCategoryListLoadQueryRequest SetAvailabilityGroupName(String value)
		{
		...
		/// <returns>AvailabilityGroupCategoryListLoadQueryRequest</returns>
		/// </summary>
		public AvailabilityGroupCategoryListLoadQueryRequest SetAssigned(bool? value)
		{
			Assigned = value;
			return this;
		}
		...
		/// <returns>AvailabilityGroupCategoryListLoadQueryRequest</returns>
		/// </summary>
		public AvailabilityGroupCategoryListLoadQueryRequest SetUnassigned(bool? value)
		{
			Unassigned = value;
			return this;
		}
		...
		{
			return JsonSerializer.Deserialize<AvailabilityGroupCategoryListLoadQueryResponse>(ref reader, options);
		}

		/// <summary>
		/// Send the request for a response, blocking
		/// <returns>AvailabilityGroupCategoryListLoadQueryResponse</returns>
		/// </summary>
		public new AvailabilityGroupCategoryListLoadQueryResponse Send()
		{
			return Client.SendRequestAsync<AvailabilityGroupCategoryListLoadQueryRequest, AvailabilityGroupCategoryListLoadQueryResponse>(this).Result;
		}

		/// <summary>
		/// Send the request for a response, async
		/// <returns>Task<AvailabilityGroupCategoryListLoadQueryResponse></returns>
		/// </summary>
		public new async Task<AvailabilityGroupCategoryListLoadQueryResponse> SendAsync()
		{
			if (Client == null) throw new MerchantAPIException("Client not assigned to request");

			return await Client.SendRequestAsync<AvailabilityGroupCategoryListLoadQueryRequest, AvailabilityGroupCategoryListLoadQueryResponse>(this);
		}
	}
}
