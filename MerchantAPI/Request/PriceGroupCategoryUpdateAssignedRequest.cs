...
namespace MerchantAPI
{
	...
	/// <see>https://docs.miva.com/json-api/functions/pricegroupcategory_update_assigned</see>
	/// </summary>
	...
	public class PriceGroupCategoryUpdateAssignedRequest : Request
	{
		...
		/// </summary>
		public PriceGroupCategoryUpdateAssignedRequest(BaseClient client = null, PriceGroup priceGroup = null) :
			base(client)
		{
			Function = "PriceGroupCategory_Update_Assigned";
			if (priceGroup != null) {
				if (priceGroup.Id > 0)
				{
				...
				{
					EditPriceGroup = priceGroup.Name;
				}
				else if (priceGroup.Name.Length > 0)
				{
		...
		/// <returns>PriceGroupCategoryUpdateAssignedRequest</returns>
		/// </summary>
		public PriceGroupCategoryUpdateAssignedRequest SetCategoryId(int? value)
		{
			CategoryId = value;
			return this;
		}
		...
		/// <returns>PriceGroupCategoryUpdateAssignedRequest</returns>
		/// </summary>
		public PriceGroupCategoryUpdateAssignedRequest SetEditCategory(String value)
		{
			EditCategory = value;
			return this;
		}
		...
		/// <returns>PriceGroupCategoryUpdateAssignedRequest</returns>
		/// </summary>
		public PriceGroupCategoryUpdateAssignedRequest SetCategoryCode(String value)
		{
			CategoryCode = value;
			return this;
		}
		...
		/// <returns>PriceGroupCategoryUpdateAssignedRequest</returns>
		/// </summary>
		public PriceGroupCategoryUpdateAssignedRequest SetPriceGroupId(int? value)
		{
			PriceGroupId = value;
			return this;
		}
		...
		/// <returns>PriceGroupCategoryUpdateAssignedRequest</returns>
		/// </summary>
		public PriceGroupCategoryUpdateAssignedRequest SetEditPriceGroup(String value)
		{
		...
		/// <returns>PriceGroupCategoryUpdateAssignedRequest</returns>
		/// </summary>
		public PriceGroupCategoryUpdateAssignedRequest SetPriceGroupName(String value)
		{
		...
		/// <returns>PriceGroupCategoryUpdateAssignedRequest</returns>
		/// </summary>
		public PriceGroupCategoryUpdateAssignedRequest SetAssigned(bool value)
		{
			Assigned = value;
			return this;
		}
		...
		{
			return JsonSerializer.Deserialize<PriceGroupCategoryUpdateAssignedResponse>(ref reader, options);
		}

		/// <summary>
		/// Send the request for a response, blocking
		/// <returns>PriceGroupCategoryUpdateAssignedResponse</returns>
		/// </summary>
		public new PriceGroupCategoryUpdateAssignedResponse Send()
		{
			return Client.SendRequestAsync<PriceGroupCategoryUpdateAssignedRequest, PriceGroupCategoryUpdateAssignedResponse>(this).Result;
		}

		/// <summary>
		/// Send the request for a response, async
		/// <returns>Task<PriceGroupCategoryUpdateAssignedResponse></returns>
		/// </summary>
		public new async Task<PriceGroupCategoryUpdateAssignedResponse> SendAsync()
		{
			if (Client == null) throw new MerchantAPIException("Client not assigned to request");

			return await Client.SendRequestAsync<PriceGroupCategoryUpdateAssignedRequest, PriceGroupCategoryUpdateAssignedResponse>(this);
		}
	}
}
